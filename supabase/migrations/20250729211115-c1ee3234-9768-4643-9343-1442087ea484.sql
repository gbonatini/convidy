...
-- 7. Company users can manage registrations for their events (keep existing public policies)
...
-- 8. Company users can manage their company events (keep existing public policies)
...
-- 9. Create secure policies for companies (keep existing public policies)
...
-- 10. Company users can manage their notification settings (keep existing policies)
